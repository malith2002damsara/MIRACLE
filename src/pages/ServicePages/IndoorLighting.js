  ...
  return (
    ...
    >
      <Typography
        variant="h4"
        gutterBottom
        sx={{ color: darkMode ? '#FFD700' : '#1E90FF' }}
      >
        Indoor Lighting
      </Typography>
      <Typography variant="body1" paragraph>
        Our indoor lighting solutions create the perfect ambiance for your event. From elegant to cozy, our lighting enhances the atmosphere of any indoor space.
      </Typography>
        ...
        >
          ...
          <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%' }}>
            ...
            <CardMedia
              ...
              alt={`Indoor Lighting ${currentImageIndex + 1}`}
              sx={{
                maxWidth: '90%',
                maxHeight: '80vh',
                objectFit: 'contain',
