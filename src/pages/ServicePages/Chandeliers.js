  ...
  return (
    <Container sx={{ py: 10 }}>
      ...
      <Typography variant="body1" paragraph sx={{  color: darkMode ? '#FFD700' : 'black' }}>
        Our Chandeliers bring elegance and luxury to any venue. Ideal for weddings, formal dinners, and special events, these stunning pieces add an unforgettable visual statement to your setting.
      </Typography>
        ...
        >
          ...
          <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%' }}>
            ...
            <CardMedia
              ...
              alt={`Chandelier ${currentImageIndex + 1}`}
              sx={{
                maxWidth: '90%',
                maxHeight: '80vh',
                objectFit: 'contain',
