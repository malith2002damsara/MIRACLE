...
const images = [
  '/images/backdrop-lighting-1.jpg',
  '/images/backdrop-lighting-2.jpg',
  '/images/backdrop-lighting-3.jpg',
  '/images/backdrop-lighting-4.jpg',
  '/images/backdrop-lighting-5.jpg',
];
...
const BackdropLighting = ({ darkMode }) => {
  ...
  return (
    ...
    >
      <Typography variant="h4" gutterBottom sx={{ color: darkMode ? '#FFD700' : '#1E90FF' }}>
        Backdrop Lighting
      </Typography>
      <Typography variant="body1" paragraph>
        Our Backdrop Lighting transforms any wall or drapery into a stunning focal point. Ideal for weddings and photography, these lights add a dreamy ambiance to your decor.
      </Typography>
        ...
        >
          ...
          <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%' }}>
            ...
            <CardMedia
              ...
              alt={`Backdrop Lighting ${currentImageIndex + 1}`}
              sx={{
                maxWidth: '90%',
                maxHeight: '80vh',
                objectFit: 'contain',
