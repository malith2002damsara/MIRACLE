  ...
  return (
    <Container sx={{ py: 8 }}>
      ...
      <Typography variant="body1" paragraph sx={{ color: darkMode ? '#FFD700' : 'black' }}>
        Our outdoor lighting solutions illuminate your space beautifully, adding charm and safety to your event. These lights are durable and perfect for any outdoor setup.
      </Typography>
        ...
        >
          ...
          <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%' }}>
            ...
            <CardMedia
              ...
              alt={`Outdoor Lighting ${currentImageIndex + 1}`}
              sx={{
                maxWidth: '90%',
                maxHeight: '80vh',
                objectFit: 'contain',
