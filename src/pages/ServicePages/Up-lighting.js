  ...
  return (
    <Container sx={{ py: 8 }}>
      ...
      <Typography variant="body1" paragraph sx={{ color: darkMode ? '#FFD700' : 'black' }}>
        Up-lighting enhances the architectural beauty of your venue, providing a sophisticated and dramatic atmosphere. These lights are perfect for creating depth and ambiance at any event.
      </Typography>
        ...
        >
          ...
          <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%' }}>
            ...
            <CardMedia
              ...
              alt={`Up-lighting ${currentImageIndex + 1}`}
              sx={{
                maxWidth: '90%',
                maxHeight: '80vh',
                objectFit: 'contain',
