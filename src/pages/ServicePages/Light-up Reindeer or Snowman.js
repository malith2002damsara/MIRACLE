  ...
  return (
    <Container sx={{ py: 8 }}>
      ...
      <Typography variant="body1" paragraph sx={{ color: darkMode ? '#FFD700' : 'black' }}>
        Our light-up reindeer and snowmen are perfect for adding a fun, festive touch to your holiday decor. They brighten up your space and delight guests of all ages.
      </Typography>
        ...
        {images.map((image, index) => (
          ...
          >
            <CardMedia
              component="img"
              image={image}
              alt={`Light-up Reindeer or Snowman ${index + 1}`}
        ...
        >
          ...
          <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%' }}>
            ...
            <CardMedia
              ...
              alt={`Light-up Reindeer or Snowman ${currentImageIndex + 1}`}
              sx={{
                maxWidth: '90%',
                maxHeight: '80vh',
                objectFit: 'contain',
