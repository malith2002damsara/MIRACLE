    ...
    <Container sx={{ py: 10 }}>
      <Box sx={{ textAlign: 'center', mb: 4 }}>
        ...
        <Typography variant="body1" paragraph sx={{ color: darkMode ? '#FFD700' : 'black' }}>
          Festoon Lights add a classic, vintage charm to any event. These decorative bulbs provide a warm, romantic ambiance, making them ideal for weddings and outdoor gatherings.
        </Typography>
        ...
        >
          ...
          <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%' }}>
            ...
            <CardMedia
              ...
              alt={`Festoon Light ${currentImageIndex + 1}`}
              sx={{
                maxWidth: '90%',
                maxHeight: '80vh',
                objectFit: 'contain',
