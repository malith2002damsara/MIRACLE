  ...
  return (
    <Container sx={{ py: 8 }}>
      ...
      <Typography variant="body1" paragraph sx={{ color: darkMode ? '#FFD700' : 'black' }}>
        String Lights offer a warm, inviting glow, perfect for outdoor celebrations. These versatile lights can be arranged in a variety of styles to suit any theme.
      </Typography>
        ...
        >
          ...
          <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%' }}>
            ...
            <CardMedia
              ...
              alt={`String Lights ${currentImageIndex + 1}`}
              sx={{
                maxWidth: '90%',
                maxHeight: '80vh',
                objectFit: 'contain',
